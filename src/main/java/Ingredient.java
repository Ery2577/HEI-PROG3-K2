...
public class Ingredient {
    ...
    private List<Order.StockMovement> stockMovementList;

    public Ingredient() {
    }

    public Ingredient(Integer id, String name, CategoryEnum category, Double price, List<Order.StockMovement> stockMovementList) {
        this.id = id;
        this.name = name;
    ...
    public List<Order.StockMovement> getStockMovementList() {
        return stockMovementList;
    }

    public void setStockMovementList(List<Order.StockMovement> stockMovementList) {
        this.stockMovementList = stockMovementList;
    }

    public StockValue getStockValueAt(Instant t) {
        if (stockMovementList == null) return null;
        Map<Unit, List<Order.StockMovement>> unitSet = stockMovementList.stream()
